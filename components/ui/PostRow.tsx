  ...
  return (
    ...
    >
      <PostThumb
        thumb={post.thumb}
        alt={post.title}
        className="aspect-[16/10] w-[92px] shrink-0 overflow-hidden rounded-lg border border-line sm:w-[176px]"
      />
      <div className="min-w-0 flex-1">
        ...
        <h3 className="mt-2.5 text-[1.2rem] font-semibold leading-snug tracking-[-0.01em] text-ink transition-colors group-hover:text-purple-deep sm:text-[1.45rem]">
          {post.title}
        </h3>
        <p className="mt-2 max-w-[68ch] text-[0.95rem] leading-[1.58] text-ink-soft sm:text-[0.97rem]">
          {post.blurb}
        </p>
        <p className="mono mt-3 text-[11px] text-ink-faint">{post.reactions} reactions on LinkedIn</p>
      </div>
      <ArrowUpRight
