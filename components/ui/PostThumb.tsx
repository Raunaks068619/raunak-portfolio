...
/**
 * Post previews. design-taste links a GitHub project, so it gets a real
 * preview image. The LinkedIn write-ups can't be fetched (LinkedIn blocks
 * bots), so each gets a small on-brand motif tied to what the post is about:
 * a JSONL ledger, an agent graph, stacked browser environments.
 */
function Ledger() {
  return (
